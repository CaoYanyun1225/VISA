...
class MergedVisualizationApp:
    ...
    def create_heatmap_controls(self, parent):
        ...
        ttk.Label(info_frame, text="• X-axis = Shape 1, Y-axis = Shape 2", 
                  font=("TkDefaultFont", 8)).pack(anchor=tk.W)
        ttk.Label(info_frame, text="• Uses current Sample Number for comparison", 
                  font=("TkDefaultFont", 8)).pack(anchor=tk.W)
    ...
    def create_advanced_visualization(self, parent):
        ...
        # 上半部分：Heatmap
        heatmap_frame = ttk.LabelFrame(viz_paned, text="Heatmap Visualization")
    ...
    def update_attention_plot(self):
        ...
        try:
            ...
            self.attention_ax.set_title(
                f'Attention Values: Sample {sample_idx + 1}, Top {shape_count} Shapes (High to Low)')
    ...
    def generate_single_click_comparison(self, shape1_idx, shape2_idx):
        ...
        try:
            ...
            # 更新信息显示
            info_text = f"Comparison generated: Sample {current_sample_idx + 1}, Shapes {shape1_idx + 1} vs {shape2_idx + 1}"
    ...
    def show_comparison_window(self, sample1_idx, shape1_idx, length1, start1, end1, label1,
        ...
        ax1.set_title(
            f'Sample {sample1_idx + 1}, Shape {shape1_idx + 1}\nTime: {start1}-{end1}, Dimension: {int(label1)}')
        ...
        ax2.set_title(
            f'Sample {sample2_idx + 1}, Shape {shape2_idx + 1}\nTime: {start2}-{end2}, Dimension: {int(label2)}')
